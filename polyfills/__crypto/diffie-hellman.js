...
new BN$1(16);
new BN$1(8);
var TEN$1 = new BN$1(10);
var THREE$1 = new BN$1(3);
new BN$1(7);
var ELEVEN$1 = new BN$1(11);
var FOUR = new BN$1(4);
new BN$1(12);
var primes$2 = null;
...
function findPrime(bits, gen) {
  if (bits < 16) {
    ...
    if (gen === 2 || gen === 5) {
      return new BN$1([0x8c, 0x7b]);
    } else {
      return new BN$1([0x8c, 0x27]);
    }
  }
  gen = new BN$1(gen);
  ...
  while (true) {
    num = new BN$1(randomBytes$1(Math.ceil(bits / 8)));
...
var DiffieHellmanGroup = browser$1.DiffieHellmanGroup = createDiffieHellmanGroup = browser$1.createDiffieHellmanGroup = getDiffieHellman_1 = browser$1.getDiffieHellman = getDiffieHellman;
var createDiffieHellman_1 = browser$1.createDiffieHellman = DiffieHellman = browser$1.DiffieHellman = createDiffieHellman;

export { DiffieHellman, DiffieHellmanGroup, createDiffieHellman_1 as createDiffieHellman, createDiffieHellmanGroup, browser$1 as default, getDiffieHellman_1 as getDiffieHellman };
